...
public class MainActivity extends Activity {
    public static final int NAM_OF_COLUMN = 13;
    ...
    private String [][] gridViewData = new String[NAM_OF_COLUMN][NUM_OF_ROW];//gridViewData[x][y]
...
//    private TextView testKeyboard;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setNumColumns(NAM_OF_COLUMN);
        gridView.setColumnWidth((int) ((gridView.getWidth() / NAM_OF_COLUMN) * 0.9));
        //reset color onclick
...
//        gridView.sethei(gridView.getWidth()/NAM_OF_COLUMN);
    ...
    private void setOnTouchKeyboard()
    {
        for(int i = 0;i<keyboard_btn.length;i++)
        {
            ...
            //Setup size of each cell
//            keyboard_btn[i].button.setWidth(gridView.getWidth()/NAM_OF_COLUMN);
//            keyboard_btn[i].button.setHeight(gridView.getHeight()/NUM_OF_ROW);
        }
...
//                testKeyboard.setText(testKeyboard.getText() + kbtn.key);
    ...
    private void initializeQuestion()
    {
        ...
        objManger.add(new WordObject(1,2,"Test Question 4","zz4",WordObject.HORIZONTAL));
        objManger.add(new WordObject(1,0,"Test Question 5","pp4",WordObject.VERTICAL));

        objManger.add(new WordObject(0,12,"Test Question 6","1234567891234",WordObject.HORIZONTAL));
        objManger.add(new WordObject(12,0,"Test Question 7","1234567891234",WordObject.VERTICAL));
    }
